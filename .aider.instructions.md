# INSTRUCCIONES DE ARQUITECTO SENIOR
...
## REGLAS ESPECÍFICAS PARA AIDER/OPENCODE
1. Sigue el Protocolo SDD estrictamente.
2. PASO 1 SIEMPRE es inventario. NO escribas código hasta el PASO 4.
3. Respuestas ultra-concisas (caveman style).
